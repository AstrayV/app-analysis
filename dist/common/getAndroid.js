...
exports.default = (function (filePath) {
    return new Promise(function (res, rej) {
        parser.parse(filePath, function (err, info) { return __awaiter(_this, void 0, void 0, function () {
            var appInfo, reader, image, iconPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ApkReader.open(filePath)];
                    case 1:
                        reader = _a.sent();
                        return [4 /*yield*/, reader.readContent(appInfo.icon)];
                    case 2:
                        image = _a.sent();
                        iconPath = "../android-icon/" + appInfo.name + "android" + appInfo.version + "-icon.png";
                        ...
                        //     iconPath
                        // }
                        res(__assign({}, appInfo, { iconPath: iconPath }));
                        return [2 /*return*/];
                }
            });
        }); });
